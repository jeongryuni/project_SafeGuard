package com.safeguard.ljr.controller;
...
@Slf4j
@RestController("ljrComplaintController")
@RequestMapping("/api/ljr/complaints")
...
public class ComplaintController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getMyComplaints(
        ...
        List<Map<String, Object>> myComplaints = complaintMapper.selectComplaintListByUserNo(params);
